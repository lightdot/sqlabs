;(function() {
    ...
    editors.Number = editors.Text.extend({
	    ...
	    // fix: event.keyCode depend to environment.
	    // drop <del> and <BS> event.
	    // from http://www.programming-magic.com/20080205235859/
	    function keyCode(e){
            ...
            var newVal = $(this.el).val() + String.fromCharCode(keyCode(event));
